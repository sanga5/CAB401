...
namespace DigitalMusicAnalysis
{
    public partial class MainWindow : Window
    {
        ...
        {
            if (waveIn == null || stftRep == null || pixelArray == null) return;
        ...
        {
            if (waveIn == null || stftRep == null) return;
            ...
            //Lowest Octif
            Rectangle[] lowestRects = new Rectangle[(int)Math.Floor(110 / divisor)];
            ...
            //Low Octif
            Rectangle[] lowRects = new Rectangle[(int)Math.Floor(220 / divisor)];
            ...
            //Middle Octif
            Rectangle[] midRects = new Rectangle[(int)Math.Floor(440 / divisor)];
            ...
            //High Octif
            Rectangle[] highRects = new Rectangle[(int)Math.Floor(880 / divisor)];
            ...
            //Highest Octif
            Rectangle[] highestRects = new Rectangle[(int)Math.Floor(1760 / divisor)];
            for (int ii = 0; ii < (int)Math.Floor(1760 / divisor); ii++)
            {
                ...
                highestRects[ii].Height = HIGHEST.heights[ii] / absMax;
        ...
        private string? openFile(string title)
        {
            ...
            return result == true ? fileOpen.FileName : null;
        }
        ...
        private void loadWave(string filename)
        {
            ...
            {
                MessageBox.Show($"Failed to load wave file: {ex.Message}", "Error", MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
        ...
        private void onsetDetection()
        {
            ...
            Console.WriteLine("Starting onset detection...");
            var onsetTimer = Stopwatch.StartNew();
            ...
            Parallel.For(0, stftRep.timeFreqData[0].Length, parallelOptions, jj =>
            {
                ...
                {
                    localHFC += (float)Math.Pow((double)stftRep.timeFreqData[ii][jj] * ii, 2);
                }
